...
/** Utility functions used by the Blackbook Qt UI.
 */
namespace GUIUtil
{
...
// Render Blackbook addresses in monospace font
...
// Parse "blackbook:" URI into recipient object, return true on successful parsing
