                                                                            ...
                                                                            spinnerFrame(0)
{
	...
	labelEncryptionIcon->setStyleSheet(".QPushButton { background-color:#232C31;}");
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Blackbook address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blackbook: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Blackbook Core"), this);
    aboutAction->setStatusTip(tr("Show information about Blackbook Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Blackbook"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Blackbook addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Blackbook addresses"));
    ...
    openAction->setStatusTip(tr("Open a Blackbook: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Blackbook Core help message to get a list with possible Blackbook command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Blackbook Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Blackbook network", "", count));
}
...
{
    QString strTitle = tr("Blackbook Core"); // default title
