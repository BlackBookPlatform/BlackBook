...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Blackbook Core"),
     ...
     * override -datadir in the blackbook.conf file in the default data directory
     * (to be consistent with blackbookd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
