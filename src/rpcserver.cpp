...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Blackbook server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Blackbook server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Blackbook features */
        {"blackbook", "masternode", &masternode, true, true, false},
        {"blackbook", "masternodelist", &masternodelist, true, true, false},
        {"blackbook", "mnbudget", &mnbudget, true, true, false},
        {"blackbook", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"blackbook", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blackbook", "mnsync", &mnsync, true, true, false},
        {"blackbook", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"blackbook", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use blackbookd, or the -server option to blackbook-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> blackbook-cli " + methodname + " " + args + "\n";
}
