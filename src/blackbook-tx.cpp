...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Blackbook Core blackbook-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blackbook-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blackbook transaction") + "\n" +
                               "  blackbook-tx [options] -create [commands]   " + _("Create hex-encoded blackbook transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blackbook transaction
