...
In order to support loading of multiple wallets in blackbook-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blackbook.cpp.
...
Changes to blackbook.cpp
----------------------
blackbook.cpp is the entry point into blackbook-qt, and as such, will require some minor modifications to provide hooks for
