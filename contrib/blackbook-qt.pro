...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/blackbook-cli.cpp \
           src/blackbook-tx.cpp \
           src/blackbook.cpp \
           src/db.cpp \
           ...
           src/qt/blackbook.cpp \
           src/qt/blackbookstrings.cpp \
...
RESOURCES += src/qt/blackbook.qrc src/qt/blackbook_locale.qrc

TRANSLATIONS += src/qt/locale/blackbook_bg.ts \
                src/qt/locale/blackbook_de.ts \
                src/qt/locale/blackbook_en.ts \
                src/qt/locale/blackbook_es.ts \
                src/qt/locale/blackbook_fi.ts \
                src/qt/locale/blackbook_fr.ts \
                src/qt/locale/blackbook_it.ts \
                src/qt/locale/blackbook_ja.ts \
                src/qt/locale/blackbook_pl.ts \
                src/qt/locale/blackbook_pt.ts \
                src/qt/locale/blackbook_ru.ts \
                src/qt/locale/blackbook_sk.ts \
                src/qt/locale/blackbook_sv.ts \
                src/qt/locale/blackbook_vi.ts \
                src/qt/locale/blackbook_zh_CN.ts \
                src/qt/locale/blackbook_zh_TW.ts
